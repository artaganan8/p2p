		...
		<script type="text/javascript">
			$(function(){
				...
				$("#showBindEmailModal").click(function(){
					//清除表单
					$("#bindEmailForm").clearForm(true);
					//显示模态框
					$("#bindEmailModal").modal("show");
				})
				//点击保存按钮,发送绑定邮件的信息,提交表单
				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						<div class="panel-body el-account">
                            ...
                            <div class="row h4 account-info">
                                <div class="col-sm-4">
                                    体验金可用金额：<span class="text-primary">${((expAccount.usableAmount)!0.00)?string("0.00")}元</span>
                                </div>
                                <div class="col-sm-4">
                                    体验金冻结金额：<span class="text-primary">${((expAccount.freezedAmount)!0.00)?string("0.00")}元</span>
                                </div>
                                <div class="col-sm-4">
                                    体验金待收总额：<span class="text-primary">${((expAccount.unReturnExpAmount)!0.00)?string("0.00")}元</span>
                                </div>
                            </div>
